@extends('admin.layouts.main',['title' => 'Sambutan Lurah'])
@section('headerside')
    ...
    <form action="{{ route('lurah.update', $sambutan->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        ...
                        <input type="file" id="fileinput"
                            class="form-control-file  @error('gambar_lurah') is-invalid @enderror" name="gambar_lurah">
                        @error('gambar_lurah')
                        <span class="invalid-feedback" role="alert">
                            <strong class="text-danger">{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        <img id="image" src="{{ asset('storage/' . $sambutan->gambar_lurah) }}" alt="" height="130rem"
                            width="100rem" style="border-radius: 3%">
                ...
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <input id="sambutan_lurah" class="form-control @error('sambutan_lurah') is-invalid @enderror"
                            type="hidden" name="sambutan_lurah"
    ...
    <form action="{{ route('lurah.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        <img id="image" src="{{ asset('assets/img/choose-image.png') }}" alt="" height="70rem"
                            width="100rem" style="border-radius: 3%">
                    </div>
                </div> <!-- /.col -->
                <div class="col-md-12">
                    <div class="card-body">
                        <h5 class="card-title">Sambutan Lurah</h5>
                        <input id="sambutan_lurah" class="form-control @error('sambutan_lurah') is-invalid @enderror"
                            type="hidden" name="sambutan_lurah" value="{{ old('sambutan_lurah') }}">
                        @error('sambutan_lurah')
                        <span class="invalid-feedback" role="alert">
                            <strong class="text-danger">{{ $message }}</strong>
                        </span>

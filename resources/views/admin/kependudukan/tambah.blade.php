                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <div class="card-header">
                                <a href="{{ route('datapenduduk.index') }}" class="btn btn-secondary"><i
                                        class="fe fe-arrow-left"></i> Kembali</a>
                            </div>
                            {{-- form --}}
                            <form action="{{ route('datapenduduk.store') }}" method="POST">
                                ...
                                <div class="row mb-3 mt-3">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control select2" id="simple-select2" name="id_rt" autofocus
                                            required>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input name="alamat" type="text" id="simpleinput"
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" id="usia"
                                                ...
                                                value="{{ old('usia') }}" name="usia" placeholder="Usia" required>
                                            @error('usia')
                                            <span class="invalid-feedback" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control select2" id="simple-select2" name="status" required>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control select2" id="simple-select2" name="golongan_darah"
                                            required>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="suku"
                                                class="form-control @error('suku') is-invalid @enderror"
                                                value="{{ old('suku') }}" name="suku" placeholder="Etnis/Suku" required>
                                            @error('suku')
                                            <span class="invalid-feedback" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control select2" id="simple-select2" name="id_pendidikan">

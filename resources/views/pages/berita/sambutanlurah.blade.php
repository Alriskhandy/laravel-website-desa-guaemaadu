...
<section id="blog" class="blog">
    <div class="container" data-aos="fade-up">
        <div class="row">
            ...
            {{-- side berita --}}
            <div class="col-lg-5">
                <div class="sidebar sticky-top m-0 mb-5">
                    ...
                    <div class="col-sm-12">
                        <article class="entry">
                            ...
                            <div class="text-center">
                                <img src="{{ asset('storage/' . $sambutanLurah->gambar_lurah) }}" alt=""
                                    class="img-fluid">
                            </div>

                            <h2 class="entry-title">
                                <a href="{{ route('sambutanlurah', $sambutanLurah->nama_lurah) }}">{{
                                    $sambutanLurah->nama_luurah }}</a>
                            </h2>

                            <div class="entry-meta">
                                <ul>
                                    <li class="d-flex align-items-center"><i class="bi bi-eye"></i> <a
                                            href="{{ route('sambutanlurah', $sambutanLurah->slug) }}">{{
                                            $sambutanLurah->views }}</a></li>
                                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                            href="{{ route('sambutanlurah', $sambutanLurah->slug) }}"><time
                                                datetime="2020-01-01">{{ $sambutanLurah->updated_at->format('M d, Y')
                                                }}</time></a>
                                    </li>
                                </ul>
                            </div>
